...
export function Volunteers({ volunteers, ...props }: VolunteersProps) {
  return (
    <div {...props}>
      <TitleSection src={Hand} alt="" title="Voluntários">
        <ul className="grid auto-rows-[115px] grid-cols-[repeat(auto-fill,_minmax(288px,_1fr))] items-center justify-items-center gap-8 p-5">
          {volunteers.map(({ name, picture, role, ...medias }) => (
            ...
            >
              <Image
                ...
                width={70}
                height={70}
                className="mr-4 h-[70px] w-[70px] rounded-[50%] bg-white"
              />
